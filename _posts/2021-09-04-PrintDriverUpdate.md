...
If you just want the scripts I used they are in my [GitHub Scripts repo](https://github.com/PeterDodemont/Scripts/tree/main), and a breakdown of how they work can be found [here](#AutomatingTheDriverUpdates).
