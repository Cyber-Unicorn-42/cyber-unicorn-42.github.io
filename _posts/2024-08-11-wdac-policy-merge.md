...
After the parameters there are a number of variables that are being set. These are variables instead of parameters, as they should stay the same for each run.\
